...
import heroBgMobileImg from "@/assets/img/mobile hero/join us hero phone.png";
import heroBgDesktopImg from "@/assets/img/join us desktop.png";
    ...
    <SiteLayout>
      <div className="bg-[#0F0F0F] min-h-screen text-[#A0A0A0] font-sans">
        ...
        <section className="relative overflow-hidden bg-[#0F0F0F] pt-36 pb-20 md:pt-44 md:pb-24 border-b border-[#2A2A2A]">
          ...
          <div
            className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-80 brightness-125 pointer-events-none hidden md:block"
        ...
        <section className="section-pad bg-[#0F0F0F]">
          <div className="mx-auto max-w-6xl px-5">
            {/* What We Look For Card (Mobile Only) */}
            ...
            <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr]">
              ...
              <aside className="space-y-6">
                ...
                {/* What We Look For Card (Desktop Only) */}
...
function WhatWeLookForCard() {
  return (
    <div className="rounded-2xl border border-gold/20 bg-gradient-to-br from-[#1A1A1A] to-[#16120C] p-6 text-[#A0A0A0] shadow-lg">
      ...
      <ul className="mt-4 space-y-3 text-sm font-light leading-relaxed">
        ...
        <li className="flex gap-2">
          <span className="text-[#E8A020] font-bold">·</span>
          <span>Be kind, be reliable, and be on time.</span>
        </li>
      </ul>
    </div>
  );
